    ...
    <div>
        ...
        <form>
          <div class="form-group">
            ...
            <input type="text" v-model="formData.name" class="form-control" id="name" placeholder="英雄名称" value="xxx">
          </div>
          <div class="form-group">
            <label for="gender">英雄性别</label>
            <input type="text" v-model="formData.gender" class="form-control" id="gender" placeholder="英雄性别" value="xxx">
          </div>
